...
/*
Class `event` represents an event that occurs under the context of an object's
behaviors or interactions. It can subscribe callbacks that contain `args_t`
parameters within their signatures and can will notify each subscriber when
invoked.
*/
